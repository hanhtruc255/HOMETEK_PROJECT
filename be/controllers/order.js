...
const confirmOrder = async (req, res) => {
  ...
  try {
    ...
    if (order.status !== 'Chưa xác nhận' ) {
      return res.status(400).json({ error: 'Không thể xác nhận đơn đặt hàng ở trạng thái này.' });
    }
...
module.exports = {orderRouter, cancelOrder, getOrder, confirmOrder, filterOrder, findOrder};